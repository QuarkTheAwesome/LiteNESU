...
void nes_hal_init()
{
	unsigned int vpadHandle, coreinitHandle;
	...
	OSDynLoad_FindExport(coreinitHandle, 0, "DCFlushRange", &DCFlushRange);
	OSDynLoad_FindExport(coreinitHandle, 0, "OSScreenFlipBuffersEx", &OSScreenFlipBuffersEx);
	OSDynLoad_FindExport(coreinit_handle, 0, "OSScreenGetBufferSizeEx", &OSScreenGetBufferSizeEx);
	OSDynLoad_FindExport(coreinit_handle, 0, "OSScreenClearBufferEx", &OSScreenClearBufferEx);
	OSDynLoad_FindExport(coreinit_handle, 0, "OSScreenPutPixelEx", &OSScreenPutPixelEx);
}
